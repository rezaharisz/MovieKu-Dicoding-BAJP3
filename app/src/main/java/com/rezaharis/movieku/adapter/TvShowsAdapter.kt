...
class TvShowsAdapter: PagedListAdapter<TvShowsEntities, TvShowsAdapter.TvShowsHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TvShowsHolder {
        val itemTvshow = ItemFavoritesBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return TvShowsHolder(itemTvshow)
    }
