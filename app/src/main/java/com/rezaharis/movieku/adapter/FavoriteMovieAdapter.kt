...
class FavoriteMovieAdapter: PagedListAdapter<MovieEntities, FavoriteMovieAdapter.MovieHolder>(DIFF_CALLBACK) {
        ...
        fun bind(movieEntities: MovieEntities){
            with(binding){
                ...
                itemView.setOnClickListener {
                    ...
                    intent.putExtra(DetailMovieActivity.MOVIE, movieEntities.id)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieHolder {
        ...
        return MovieHolder(itemFavoritesBinding)
    }

    override fun onBindViewHolder(holder: MovieHolder, position: Int) {
        val movieFavorites = getItem(position)
